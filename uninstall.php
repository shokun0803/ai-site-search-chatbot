...
$aiscb_settings = get_option( AISite_Search_Chatbot::OPTION_KEY, array() );
$aiscb_cleanup_mode = is_array( $aiscb_settings ) && isset( $aiscb_settings['uninstall_cleanup_mode'] )
	? sanitize_key( (string) $aiscb_settings['uninstall_cleanup_mode'] )
	: 'retain';

if ( 'delete_all' === $aiscb_cleanup_mode ) {
